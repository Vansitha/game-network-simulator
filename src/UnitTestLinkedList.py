...
#  REFERENCE: This file has been submitted previously for DSA COMP1002 Pracitcal 4
#             (Linked list) submission.
#             Ratnayake. Vansitha Induja. COMP1002 Linked Lists Practical 4 submission
#             File provided by unit coordinator as part of the DSA COMP1002 linked list
#             practical 4 resources.
#             Maxville. Valerie, 2021. DSA COMP1002 Linked List Practical 4 Resources
#  COMMENTS: No modifications were done to the code
#  LAST MOD: 16/10/21
